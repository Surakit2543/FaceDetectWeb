<?php
    ...
    <div class="row">
      ...
      <?php
		$sql = $conn->query("select * from subject  where sub_id = '$_REQUEST[id]'");
    $show = $sql->fetch_assoc();
		?>
          ...
          <div class="form-group col-md-6">
            ...
            <option selected value="">ไม่มีผู้สอน</option>
            <?php
...
if(isset($_GET['update'])){
    ...
    $sql = mysqli_query($conn,"update subject set sub_id = '$_REQUEST[subid]',sub_name = '$_REQUEST[subname]',
    sub_class = '$_REQUEST[subclass]',sub_field = '$_REQUEST[subfield]',sub_section = '$_REQUEST[subsection]',
    sub_unit = '$_REQUEST[subunit]', tc_id = $tcid where sub_id = '$_REQUEST[subid]'")or die (mysqli_error());
